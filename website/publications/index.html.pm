...
◊(define-meta title "Jackson Petty: Publications"
...
◊; ◊items[#:class "feed"]{
◊;   ◊item{
◊;     ◊span[#:class "feed-header"]{2021} ◊get-citation["tiles"]
◊;   }
◊;   ◊item{
◊;     ◊span[#:class "feed-header"]{2021} ◊get-citation["tiles-extra"]
◊;   }
◊;   ◊item{
◊;     ◊span[#:class "feed-header"]{2021} ◊get-citation["bubbles"]
◊;   }
◊;   ◊item{
◊;     ◊span[#:class "feed-header"]{2 December 2020} ◊get-citation["anaphora"] 
◊;   }
◊; }